...
//create a page router where a user can create a page and can update it and can delete it and can get all posts of a page 

const pageController = require('../controllers/pageController');
const commentController = require('../controllers/commentController');
const middleware = require('../middleware/authenticateUser');

router.post('/createPage',middleware.authenticateToken, pageController.createPage);  //need more modification like location feeling with etc
...
//search by page name
router.get('/searchPageByName/:name',middleware.authenticateToken, pageController.searchPageByName); //not tested
//search by page category
router.get('/searchPageByCategory/:category',middleware.authenticateToken, pageController.searchPageByCategory); //not tested
...
router.put('/updatePostFromPage/:id',middleware.authenticateToken, pageController.updatePostOfPage); //recheck
//like post of page
